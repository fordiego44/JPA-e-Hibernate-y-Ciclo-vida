package com.diego.curso.springboot.jpa.apringboot_jpa;
...
import com.diego.curso.springboot.jpa.apringboot_jpa.repositories.PersonRepository;

@SpringBootApplication
public class ApringbootJpaApplication implements CommandLineRunner {

	@Autowired
	private PersonRepository repository;

	public static void main(String[] args) {
		SpringApplication.run(ApringbootJpaApplication.class, args);
	}
